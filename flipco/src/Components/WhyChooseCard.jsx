...
export default function WhyChooseCard({title, desc, img}) {
  return (
    <> 
    <div className='ml-4 mr-4 my-20 max-w-sm rounded overflow-hidden shadow-lg transition-transform duration-300 hover:shadow-2xl hover:-translate-y-4 cursor-pointer'>
